...
// Set UI labels for Custom Post Type
  $labels = array(
    'name'                => _x( 'informacoes', 'Post Type General Name', 'twentythirteen' ),
    'singular_name'       => _x( 'informacoes', 'Post Type Singular Name', 'twentythirteen' ),
    'menu_name'           => __( 'informacoes', 'twentythirteen' ),
    'parent_item_colon'   => __( 'informacoes Relacionado', 'twentythirteen' ),
    'all_items'           => __( 'Todos os informacoes', 'twentythirteen' ),
    'view_item'           => __( 'Ver informacoes', 'twentythirteen' ),
    'add_new_item'        => __( 'Adicionar novo informacoes', 'twentythirteen' ),
    'add_new'             => __( 'Adicionar novo', 'twentythirteen' ),
    'edit_item'           => __( 'Editar informacoes', 'twentythirteen' ),
    'update_item'         => __( 'Atualizar informacoes', 'twentythirteen' ),
    'search_items'        => __( 'Buscar por informacoes', 'twentythirteen' ),
...
// Set other options for Custom Post Type
  ...
  $args = array(
    'label'               => __( 'informacoes', 'twentythirteen' ),
    'description'         => __( 'informacoes news and reviews', 'twentythirteen' ),
    'labels'              => $labels,
